...
<html lang="en">
	<head>
	    ...
	    <title>Mutriz.Inc online shopping</title>
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading orange">free Delivery within CBD</h4>
						</div>
					</div>
					<h6 class="text">For counties outside Nairobi shipping fee is 300</h6>	
				</div>
			</div><!-- .col -->
